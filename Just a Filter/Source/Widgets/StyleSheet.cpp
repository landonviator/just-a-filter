...
void LV_AlphaDialLAF::drawLabel(Graphics &g, Label &label)
{
    ...
    void LV_CustomNumberBox::drawLabel(Graphics &g, Label &label)
    {
        g.fillAll (label.findColour (Label::backgroundColourId));
...
void LV_CustomNumberBox::drawLinearSlider(Graphics& g, int x, int y, int width, int height,
                                          float sliderPos,
                                          float minSliderPos,
                                          float maxSliderPos,
...
void LV_CustomPushButton::drawButtonText (Graphics& g, TextButton& button,
